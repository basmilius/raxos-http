...
/**
 * Class TimeConstraintException
 *
 * @author Bas Milius <bas@mili.us>
 * @package Raxos\Http\Validate\Error
 * @since 2.0.0
 */
final class TimeConstraintException extends Exception implements ConstraintExceptionInterface
{
    ...
    {
        parent::__construct(
            'http_validation_constraint_time',
