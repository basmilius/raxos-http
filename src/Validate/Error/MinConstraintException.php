...
/**
 * Class MinConstraintException
 *
 * @author Bas Milius <bas@mili.us>
 * @package Raxos\Http\Validate\Error
 * @since 2.0.0
 */
final class MinConstraintException extends Exception implements ConstraintWithParamsExceptionInterface
{
    ...
    )
    {
        ...
        parent::__construct(
            ...
            "Must have a minimum of {$this->min}."
        );
    }
